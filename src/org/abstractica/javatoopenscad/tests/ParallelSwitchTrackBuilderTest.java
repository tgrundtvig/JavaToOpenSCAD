...
import org.abstractica.openbuildsystem.generators.trainsystem.tracks.ParallelSwitchTrackBuilder;
...
public class ParallelSwitchTrackBuilderTest implements Module3DImpl
{
	...
	public Module3D buildGeometry(CSG csg)
	{
		...
		union.add(sTrackBuilder.curveTrackSection(0,1, true));
		union.add(sTrackBuilder.curveTrackSection(0,1, false));
		union.add(sTrackBuilder.straightTrackSection(0,1, true));
		union.add(sTrackBuilder.straightTrackSection(0,1, false));
		return union;
	}
