...
import refactoring.coreimpl.core.impl.AngleImpl;
import refactoring.coreimpl.core.impl.Coord2DImpl;
import refactoring.coreimpl.core.impl.Coord3DImpl;
...
public interface CSGMath
{
	...
	public static Polar3D polar3D(double r, Angle theta, Angle elevation)
	{
		if(r == 0.0)
		{
