package org.abstractica.openbuildsystem.generators.trainsystem100.rollingstock.wheels.test;
...
import org.abstractica.openbuildsystem.generators.trainsystem100.rollingstock.wheels.TrainWheel;
...
public class TestTrainWheel implements Module3DImpl
{
	...
	public Module3D buildGeometry(CSG csg)
	{
		...
		TrainWheel tw = new TrainWheel(csg, adj);
		//return tw.trainWheel();
		//return tw.wheelWithOutsideAxle();
		return tw.axle(false, 10, true);
	}
